...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='../Dataset/VISION24-data-challenge-train/data_new/')
    #parser.add_argument('--datapath', type=str, default='/home/alex/pytorch/data')
    parser.add_argument('--save_path', type=str, default='/media/hyh/1A24C88B24C86AF9/logs')
    parser.add_argument('--benchmark', type=str, default='defect', choices=['pascal', 'coco', 'industrial', 'defect'])
    parser.add_argument('--logpath', type=str, default='defect')
    ...
    parser.add_argument('--backbone', type=str, default='resnet101', choices=['vgg16', 'resnet50', 'resnet101','net'])
